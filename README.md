...
4 Copy Amazon Trust Certificate (https://www.amazontrust.com/repository/SFSRootCAG2.pem) into /etc/ssl/cert.pem
sudo cp ~/cert.pem /etc/ssl/cert.pem

5 Run streaming demo (inside of kinesis-video-native-build directory)
